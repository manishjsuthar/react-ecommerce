                            ...
                            <div className="container">
                                <div className="row p-5">
                                    <div className="mx-auto col-md-8 col-lg-6 order-lg-last">
                                        <img className="img-fluid" src="../img/banner_img_01.jpg" alt="pic" />
                                    </div>
                ...
                <section className="container py-5">
                    ...
                    <div className="row">
                        <div className="col-12 col-md-4 p-5 mt-3">
                            <a href="/"><img src="../img/category_img_01.jpg" className="rounded-circle img-fluid border" alt="" /></a>
                            <h5 className="text-center mt-3 mb-3">Watches</h5>
                            <p className="text-center"><a className="btn btn-success" href="/">Go Shop</a></p>
                        </div>
                        <div className="col-12 col-md-4 p-5 mt-3">
                            <a href="/"><img src="../img/category_img_02.jpg" className="rounded-circle img-fluid border" alt="" /></a>
                            <h2 className="h5 text-center mt-3 mb-3">Shoes</h2>
                            <p className="text-center"><a className="btn btn-success"  href="/">Go Shop</a></p>
                        </div>
                        <div className="col-12 col-md-4 p-5 mt-3">
                            <a href="/"><img src="../img/category_img_03.jpg" className="rounded-circle img-fluid border" alt="" /></a>
